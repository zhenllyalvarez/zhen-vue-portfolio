  ...
  <MainLayout :pageTitle="pageTitle">
    <section>
      <div class="aboutme flex flex-col lg:flex-row justify-between p-12 mb-8">
        ...
        <div class="flex flex-col gap-3 mt-12 mb-12">
          ...
          <div class="flex gap-4 mt-4">
            <a href="https://www.facebook.com/john.zhenlly.56?mibextid=ZbWKwL" target="_blank"
              class="bg-gray-100 hover:bg-gray-150 shadow-md p-3 rounded-full"><svg
                class="w-[24px] h-[20px] text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.linkedin.com/in/john-zhenlly-alvarez-73021028b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app&fbclid=IwAR3oxwIaLXbYXSXn_QdAHgMnCeEZh4w0Da3PyZxAEHCLDLklUwyKbW9MvYk"
              target="_blank" class="bg-gray-100 hover:bg-gray-150 shadow-md p-3 rounded-full"><svg
                class="w-[24px] h-[20px] text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://github.com/zhenllyalvarez" target="_blank"
              class="bg-gray-100 hover:bg-gray-150 shadow-md p-3 rounded-full"><svg
                class="w-[24px] h-[24px] text-gray-600" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
